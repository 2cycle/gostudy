...
func getPage(page int, mainC chan<- []extractJOB) {
	...
	searchCards.Each(func(i int, card *goquery.Selection) {
		go makeStructeExtractJob(card, c)
...
func makeStructeExtractJob(card *goquery.Selection, c chan<- extractJOB) {
	...
	c <- extractJOB{id: id, title: title, location: location, salary: salary, summary: summary}
}
